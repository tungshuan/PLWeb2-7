...
<div>
	...
	<div class="content" style="font-size:15px;line-height:1.8em">
		...
		<ol>
			<li><a href="../doc/201109-PLWEB-HOWTO-ADD-CLASS.pdf" target="_blank">教師如何建立新課程？</a> </li>
			<li><a href="../doc/201109-PLWEB-HOWTO-USE-CLASS.pdf" target="_blank">教師如何開放課程的練習功能給學生使用？</a> </li>
			<li><a href="../doc/201109-PLWEB-HOWTO-JOIN-CLASS.pdf" target="_blank">學生如何加入教師建立的課程？</a> </li>
			<li><a href="../doc/201109-PLWEB-HOWTO-USE-EDITOR.pdf" target="_blank">學生如何開始練習？</a></li>
			 <% if(isTeacher){
                        print "<li><a href=\"../doc/20160501-PLWEB-HOWTO-MAKE-EXERCISES-AND-EXAM.pdf\" target=\"_blank\" style=\"color: red;\">教師如何建立練習題與考題</a></li>"
                 } %>
		</ol>
	</div>
	...
	<p style="margin: 0 auto;width:400px;background-color:#ffffaa;padding:15px;line-height:1.6em;font-size:15px;">＊＊如果您是教師並且有意願使用PLWeb授課，歡迎您與我們聯絡。<br>E-mail: tungsh[at]yuntech.edu.tw</p>
