...
<div class="signup-userSize">
	...
	位使用者註冊專屬帳號，歡迎您加入！
	<hr>
	<p><font color="ff0000"><b>請先安裝Java JDK：</b></font>PLWeb的程式編輯器需要在安裝了Java JDK的電腦運作。因此，請先<a target="_blank" href=http://help.plweb.org/installation:jdk>按照此說明安裝Java JDK</a>，接著在註冊完成後，記得將瀏覽器關閉，然後以重新啟動的瀏覽器登入PLWeb，之後即可下載編輯器開始練習。</p>	
	<hr>
</div>
